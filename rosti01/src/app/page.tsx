    ...
    <main className="min-h-screen" style={{backgroundColor: '#F5ECD7'}}>
      <header className="sticky top-0 z-50 shadow-sm" style={{backgroundColor: '#5C1A1A'}}>
        <div className="max-w-6xl mx-auto px-4 py-4 flex justify-between items-center">
          <Image src="/logo.jpg" alt="روستی" width={60} height={60} style={{objectFit: 'cover', borderRadius: '50%', width: '60px', height: '60px'}} />
          <nav className="flex gap-6 font-medium" style={{color: '#F0DDB0'}}>
            ...
            <a href="#" className="hover:opacity-80">درباره ما</a>
            <a href="#" className="hover:opacity-80">تماس</a>
          </nav>
        </div>
      </header>
